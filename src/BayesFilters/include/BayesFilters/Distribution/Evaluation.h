 ...
 *
 * \tparam VariateType  Random variable type
...
class Evaluation:
        public UnnormalizedEvaluation<VariateType>
{
public:
    /**
     ...
     * \return \f$p(x)\f$
     */
    virtual Real probability(const VariateType& variate) const
    {
     ...
     * \return \f$\ln(p(x))\f$
     */
    virtual Real log_probability(const VariateType& variate) const = 0;

    Real log_unnormalized_probability(const VariateType& variate) const override
    {
