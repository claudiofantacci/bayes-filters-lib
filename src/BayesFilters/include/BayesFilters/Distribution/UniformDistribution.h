...
class UniformDistribution
    : public Evaluation<Vector1d>,
      public StandardNormalDistributionMap<Vector1d, 1>
{
private:
    typedef StandardNormalDistributionMap<Vector1d, 1> StdGaussianMappingBase;

public:
    typedef Vector1d VariateType;
...
public:
    ...
    Real probability(const VariateType& x) const override
    {
        assert(x.size() == 1);
