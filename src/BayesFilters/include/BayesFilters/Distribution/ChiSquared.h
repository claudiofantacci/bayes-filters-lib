...
class ChiSquared
    : public Evaluation<ScalarMatrix>,
      public StandardNormalDistributionMap<ScalarMatrix, 1>
{
private:
    typedef StandardNormalDistributionMap<ScalarMatrix, 1> StdGaussianMappingBase;
...
public:
     ...
     */
    typedef ScalarMatrix VariateType;
...
public:
    ...
    /**
     * \brief Returns aa t-distribution sample of the type \c VariateType determined
     ...
     */
    virtual VariateType map_standard_uniform(const StandardVariate& n) const
    {
     ...
     * \throws See Gaussian<VariateType>::map_standard_normal
     */
    VariateType map_standard_normal(const StandardVariate& n) const override
    {
     ...
     */
    Real log_probability(const VariateType& variate) const override
    {
     ...
     * \return \f$p(x)\f$
     */
    Real probability(const VariateType& variate) const override
    {
        assert(variate.size() == 1);
